...
// Block all non-trading notifications — KYC, cashier, account settings, platform promos
const NON_TRADING_NOTIFICATIONS = new Set([
...
const AppNotificationMessages = observer(
    ({ is_notification_loaded, is_mt5, stopNotificationLoading, show_trade_notifications }) => {
        ...
        const notifications_msg = notification_messages.filter(message => !NON_TRADING_NOTIFICATIONS.has(message.key)).filter(message => {
